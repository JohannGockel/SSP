...
'''Load random fields'''
unum_driven_abs = np.load("unum_driven_abs_proj.npy")
unum_driven = np.load("unum_driven_proj.npy")
...
for i in [0,50,100,150]:
    ...
    plt.tight_layout()
    plt.savefig(f"/home/johann_gockel/SSP/NSE_doc/Bilder/mode_driven/turbulence_t{ts}.png")